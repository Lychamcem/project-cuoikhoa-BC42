...
import { HideEditTaskModal, deleteCommentAction, deleteTaskAction, getAllCommentAction, getTaskDetailAction, resetEditTaskSuccess, updateCommentAction, updateStatusTaskAction, updateTaskAction } from '../../redux/slices/TaskManageSlice/TaskManageSlice';
...
function EditTaskModal({ projectId }) {
    ...
    return (
        <>
            <Modal width={'70%'} open={openEditTaskModal} onOk={handleOk} onCancel={handleCancel} footer={false}>
                <form className="space-y-10 ng-untouched ng-pristine ng-valid" onSubmit={handleSubmit(onSubmit, onErrors)}>
                    <div className='grid grid-cols-12 gap-5'>
                        <div className='col-span-7'>
                            <div className="space-y-2">
                                <div className='flex items-center'>
                                    <select {...register("typeId")} name="typeId" id="typeId" className="w-1/4 px-3 py-2 border border-gray-700 bg-white text-black mr-2">
                                        {
                                ...
                                <div>
                                    <label for="comments" className="block mb-2 text-sm font-semibold text-gray-500">Comments</label>
                                    <div className='flex flex-col justify-center'>
                                        {
                                            listComment?.map(comment => (
                                                <div className='flex my-2' key={comment.id}>
                                                    <div className='mr-5 font-semibold'>
                                                        <Avatar className='mr-1' src={comment.user.avatar} />
                                                        {comment.user.name}
                                                    </div>
                                                    {
                                                        comment.id === commentToEdit.id ? <div>
                                                            <textarea type="text" name="comment" id="comment" className="w-full px-3 py-2 border border-gray-700 bg-white text-black" value={commentToEdit.content} onChange={(event) => {
                                                                setCommentToEdit({
                                                                    ...commentToEdit,
                                    ...
                                    {
                                        showAddComment && <div>
                                            <textarea type="text" name="comment" id="comment" className="w-full px-3 py-2 border border-gray-700 bg-white text-black" value={commentToAdd} onChange={(event) => setCommentToAdd(event.target.value)}>
                                            </textarea>
                                            <div className='flex justify-end'>
                                                <Button htmlType='button' className='mr-1' size='small' onClick={() => {
                                                    setCommentToAdd('');
                        ...
                        <div className='col-span-5'>
                            <div className="space-y-2">
                                <div className='flex items-center'>
                                    <Button className='border-none font-semibold text-gray-500 text-lg flex items-center'>
                                        <SendOutlined className='mr-1' /> Give feedback
                                    </Button>
                                    <Button className='border-none font-semibold text-gray-500 text-lg flex items-center'>
                                        <LinkOutlined className='mr-1' /> Copy Link
                                    </Button>
                                    <Button className='border-none font-semibold text-gray-500 text-lg flex items-center' onClick={() => {
                                ...
                                <div>
                                    ...
                                    <select {...register("statusId")} name="statusId" id="statusId" className="w-1/3 px-3 py-2 border border-gray-700 bg-white text-black mr-2">
                                        {
                                ...
                                <div>
                                    <label for="listUserAssign" className="block mb-2 text-sm font-semibold text-gray-500">Assignees</label>
                                    <Dropdown
                                        menu={
                                            {
                                ...
                                <div>
                                    ...
                                    <select {...register("priorityId")} name="priorityId" id="priorityId" className="w-1/4 px-3 py-2 border border-gray-700 bg-white text-black mr-2">
                                        {
                                ...
                                <div>
                                    ...
                                    <input {...register("originalEstimate")} type="number" name="originalEstimate" id="originalEstimate" min={0} className="w-1/4 px-3 py-2 border border-gray-700 bg-white text-black" onChange={(event) => {
                                        setTimeEstimate({
