...
import {
  ...
  updateProjectAPI,
} from "../../../services/ManageProjectService";
...
export const updateProjectAction = (id, values, searchTerm, resetFormFunc) => {
  return async (dispatch) => {
    try {
...
export const assignUserProjectAction = (values, searchTerm) => {
  return async (dispatch) => {
    try {
...
export const removeUserProjectAction = (values, searchTerm) => {
  return async (dispatch) => {
    try {
